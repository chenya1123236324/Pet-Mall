...
__DEFINE__(1589206630904, function(require, module, exports) {
module.exports =
...
class Cloud {
    ...
    init(config = {}) {
        if (this.inited)
            return;
        this.inited = true;
        const instance = this.provider.init(Object.assign(Object.assign({ throwOnCode: false }, config), { version: `wx-server-sdk/${version}` }));
        const _config = Object.assign(Object.assign({}, config), { env: type_1.isObject(config.env) ? config.env : { default: config.env } });
        this.config = _config;
        this.exportAPI.logger = instance.logger.bind(instance);
    }
    updateConfig(config = {}) {
...
exports.getInstance = (config = {}) => {
    if (process.env.TENCENTCLOUD_RUNENV === 'WX_LOCAL_SCF') {
        // @ts-ignore
        const instance = tcb.init(Object.assign(Object.assign({ throwOnCode: false }, config), { env: utils_1.translateEnv(config.env), isHttp: true }));
        ...
        // @ts-ignore
        const instance = tcb.init(Object.assign(Object.assign({ throwOnCode: false }, config), { env: utils_1.translateEnv(config.env) }));
        instance.config.secretId = undefined;
        instance.config.secretKey = undefined;
        instance.config.sessionToken = undefined;
        return instance;
...
/******/ });
}, function(modId) {var map = {"./package.json":1589206630905}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1589206630905, function(require, module, exports) {
module.exports = {
  "_from": "wx-server-sdk@~2.0.1",
  "_id": "wx-server-sdk@2.0.1",
  "_inBundle": false,
  "_integrity": "sha512-08eprmughDarvDN/g3AqNj73mo3P2FQ4ymRPM4XpVeGNrnReCFlRZuv/RJB361IFVYDbFuxkIcspmNdib41elA==",
  "_location": "/wx-server-sdk",
  "_phantomChildren": {},
  "_requested": {
    "type": "range",
    "registry": true,
    "raw": "wx-server-sdk@~2.0.1",
    "name": "wx-server-sdk",
  ...
  "_resolved": "https://registry.npmjs.org/wx-server-sdk/-/wx-server-sdk-2.0.1.tgz",
  "_shasum": "0698d2b2729935835ab91f336740cb281154e338",
  "_spec": "wx-server-sdk@~2.0.1",
  ...
  "dependencies": {
    "@cloudbase/node-sdk": "2.0.0-beta.3",
    "protobufjs": "6.8.8",
    "tcb-admin-node": "1.22.1",
    "tslib": "^1.9.3"
  },
  "deprecated": false,
...
return __REQUIRE__(1589206630904);
})()
